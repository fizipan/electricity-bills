                                                    ...
                                                    <tbody>
                                                        @forelse($customer_usage as $key => $usage)
                                                            <tr data-entry-id="{{ $usage->id }}">
                                                                <td>{{ date('d/m/Y H:i:s', strtotime($usage->created_at)) ?? '' }}</td>
                                                                    ...
                                                                    <div class="btn-group mr-1 mb-1">
                                                                        ...
                                                                        <div class="dropdown-menu">
                                                                            ...
                                                                            @can('customer_usage_edit')
                                                                                <a class="dropdown-item" href="{{ route('backsite.customer_usage.edit', $usage->id) }}">
                                                                                    Edit
                                                                                </a>
                                                                            @endcan
                                                                            @can('customer_usage_delete')
                                                                                <form action="{{ route('backsite.customer_usage.destroy', $usage->id) }}" method="POST" onsubmit="return confirm('Are you sure want to delete this data ?');">
                                            ...
                                            <div class="table-responsive">
                                                <div class="text-center mb-3">
                                                    @if ($customer_usage->hasPages())
                                                        ...
                                                        <p class="mt-1"><code class="text-dark">Page {{ $customer_usage->currentPage() }}</code> & <code>All data {{ $customer_usage->total() }}</code></p>
                                                    @endif
                                                    <nav aria-label="Page navigation">
                                                        @if ($customer_usage->hasPages())
                                                            <ul class="pagination justify-content-center pagination-round">
                                                                ...
                                                                @else
                                                                    <li class="page-item">
                                                                        <a class="page-link" href="{{ $customer_usage->previousPageUrl() }}" aria-label="Previous">
                                                                            <span aria-hidden="true"><i class="ft-chevron-left"></i></span>
                                                                            <span class="sr-only"><i class="ft-chevron-left"></i></span>
                                                                        </a>
                                                                    </li>
                                                                ...
                                                                @if($customer_usage->currentPage() > 2)
                                                                    <li class="page-item"><a class="page-link" href="{{ $customer_usage->url(1) }}">1</a></li>
                                                                @endif
                                                                ...
                                                                @foreach(range(1, $customer_usage->lastPage()) as $i)
                                                                    @if($i >= $customer_usage->currentPage() - 1 && $i <= $customer_usage->currentPage() + 1)
                                                                        ...
                                                                        @else
                                                                            <li class="page-item"><a class="page-link" href="{{ $customer_usage->url($i) }}">{{ $i }}</a></li>
                                                                        @endif
                                                                    @endif
                                                                @endforeach
                                                                ...
                                                                @if($customer_usage->currentPage() < $customer_usage->lastPage() - 2)
                                                                    <li class="page-item"><a class="page-link" href="{{ $customer_usage->url($customer_usage->lastPage()) }}">{{ $customer_usage->lastPage() }}</a></li>
                                                                @endif

                                                                {{-- Next Page Link --}}
                                                                @if ($customer_usage->hasMorePages())
                                                                    <li class="page-item">
                                                                        <a class="page-link" href="{{ $customer_usage->nextPageUrl() }}" aria-label="Next">

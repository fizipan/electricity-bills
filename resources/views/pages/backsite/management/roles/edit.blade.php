                    ...
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="{{ route('backsite.roles.index') }}" onclick="return confirm('Are you sure close this page ?')">Role</a>
                                </li>
                            ...
                            <div class="card">
                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        <form class="form form-horizontal" action="{{ route("backsite.roles.update", [$role->id]) }}" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <div class="col-md-9 mx-auto">
                                                            ...
                                                            <select name="permissions[]" 
                                                                ...
                                                                @foreach($permissions as $id => $permission)
                                                                    <option value="{{ $permission->id }}" {{ (in_array($permission->id, old('permissions', [])) || isset($role) && $role->permissions->contains($permission->id)) ? 'selected' : '' }}>{{ $permission->title }} | {{ $permission->menus->name }}</option>
                                                                @endforeach
                                                            </select>
